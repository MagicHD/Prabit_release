                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'ex2fuw84' /* Sign in to your account to con... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '8nol2hvf' /* Don't have an account?  */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
